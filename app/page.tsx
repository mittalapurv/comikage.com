...
import { ArrowDown, ArrowRight, Check, GearSix, List, Robot, X, Browser, CaretDown } from "@phosphor-icons/react";

const nav = [["Services", "#services"], ["Approach", "#approach"], ["Packages", "#packages"], ["Contact", "#contact"]];
...
const services = [
  { icon: Browser, n: "01", title: "Business Websites", text: "Professional websites that communicate clearly, establish credibility, and generate enquiries." },
  { icon: GearSix, n: "02", title: "Business Applications", text: "Internal tools, dashboards, portals, CRMs, approval workflows, and custom software for businesses that have outgrown spreadsheets." },
  { icon: Robot, n: "03", title: "AI & Automation", text: "Practical AI systems that reduce repetitive work, improve access to information, and support faster decision-making." }
];
