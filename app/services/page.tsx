...
export const metadata: Metadata = {
  title: "Services — Comikage",
  description: "Comikage offers business websites, custom business applications, and practical AI automation systems for founders and growing companies."
};
  ...
  return (
    <Page>
      <PageHero
        ...
        body={<p>Comikage helps businesses define, design, and build websites, applications, and AI-assisted workflows that support real business outcomes.</p>}
      />
      ...
      <Section eyebrow="Or browse the three practice areas" title="The right digital scope" surface>
        <Prose>
          <p>
            ...
            dashboards, client portals, workflow systems, or automation. Comikage helps identify the right digital scope before development begins.
          </p>
        </Prose>
      ...
      <CTASection
        ...
        body="That is exactly where Comikage is useful. We help clarify whether your first step should be a website, an application, automation, or a phased combination."
